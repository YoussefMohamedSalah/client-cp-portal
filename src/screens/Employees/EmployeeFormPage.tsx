    ...
    const formFields: IField[] = [
        {
            ...
            onChange: (value: string) =>
                handleModelData(EmployeeKeys.NAME, value),
        ...
        },
        {
            ...
            onChange: (value: any) =>
                handleModelData(EmployeeKeys.CONTRACT_DATE, value),
        ...
        },
        {
            ...
            onChange: (value: any) =>
                handleModelData(EmployeeKeys.CONTRACT_EX_DATE, value),
            placeholder: "Enter Start Date",
        },
        {
            label: "ID Number",
        ...
        },
        {
            ...
            onChange: (value: any) =>
                handleModelData(EmployeeKeys.ID_EX_DATE, value),
...

        {
            ...
            onChange: (value: string | any) =>
                handleModelData(EmployeeKeys.ROLE, value),
            options: [
        ...
        },
        {
            ...
            onChange: (value: string) =>
                handleModelData(EmployeeKeys.GENDER, value),
            options: [
        ...
        },
        {
            ...
            onChange: (value: string) =>
                handleModelData(EmployeeKeys.PROJECT, value),
        ...
        <div className="container-xxl">
            ...
            <div className="row g-3 pb-3 pb-xl-0">
                ...
                <div className="col-sm d-flex align-items-center justify-content-center gap-2">
                    {isEdit ? (<>
                        <Button className='lift' content='Cancel' onClick={() => push('/' + PAGES.EMPLOYEES)} variant='secondary' />
                    </>) : (<>
                    ...
                    <Button className='lift' content='profile' onClick={() => push('/' + PAGES.EMPLOYEE_INFO + '/' + modelData.id)} />
                </div>
            </div>
            <DeleteModal
                show={isModal}
