...
import { SiteRequestKeys, SiteRequestNumKeys, SiteRequestRequiredKeys, SiteRequestStrKeys } from 'models/documents/SiteRequest';
    ...
    const formFields: IField[] = [
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(SiteRequestKeys.SUBJECT, value),
        ...
        },
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(SiteRequestKeys.PROJECT, value),
        ...
        },
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(SiteRequestKeys.DATE, value),
            placeholder: "",
            required: true,
        ...
        },
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(SiteRequestKeys.DESCRIPTION, value),
        ...
        <div className="container-xxl">
            ...
            <div className="row g-3 pb-3 pb-xl-0">
                ...
                <div className="col-sm d-flex align-items-center justify-content-center gap-2">
                    ...
                    {isEdit ? (<>
                        {allowEditActionBtn(documentData?.siteRequestDetails?.data?.user?.id!, documentData?.siteRequestDetails?.data!) && (
