...
import { MaterialRequestKeys, MaterialRequestNumKeys, MaterialRequestStrKeys, MaterialRequestRequiredKeys } from 'models/documents/MaterialRequest';
    ...
    const formFields: IField[] = [
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(MaterialRequestKeys.SUBJECT, value),
        ...
        },
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(MaterialRequestKeys.DATE, value),
            placeholder: "",
            required: true,
        },
        {
...
Best Regards.`,
    ...
    Best Regards.`
        ...
        try {
            ...
            if (files && files.length > 0) {
                createInput = materialRequestInput({ ...modelData, files, items: stringItems, filesNameSet: stringAddedFiles, projectId: selectedProject?.id! });
            } else {
    ...
    const handleEditRequest = async (toArchive = false) => {
        ...
        try {
            ...
            let stringAddedFiles = JSON.stringify(filesNameSet);
            if (files && files.length > 0) {
                createInput = materialEditInput({ ...modelData, items: stringItems, files, removedFilesNameSet: stringRemovedFiles, filesNameSet: stringAddedFiles, is_archived: toArchive === true ? true : false });
            } else {
                createInput = materialEditInput({ ...modelData, items: stringItems, removedFilesNameSet: stringRemovedFiles, filesNameSet: stringAddedFiles, is_archived: toArchive === true ? true : false });
            }
        ...
        <div className="container-xxl">
            ...
            <div className="row g-3 pb-3 pb-xl-0">
                ...
                <div className="col-sm d-flex align-items-center justify-content-center gap-2">
                    ...
                    {isEdit ? (<>
                        {allowEditActionBtn(documentData?.materialRequestDetails?.data?.user?.id!, documentData?.materialRequestDetails?.data!) && (
