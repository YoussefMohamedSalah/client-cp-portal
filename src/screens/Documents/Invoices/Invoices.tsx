...
const Invoiced: React.FC = () => {
    ...
    return (
        <>
            ...
            {selectedDocument && selectedDocument.status !== ENUMS.STATUS.ARCHIVED && <WorkFlowStatusModal<Invoice> handleClose={handleClose} open={open} selectedDocument={selectedDocument} />}
        </>
    );
};
