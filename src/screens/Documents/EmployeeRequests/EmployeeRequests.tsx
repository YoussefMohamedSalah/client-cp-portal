...
const EmployeeRequests: React.FC = () => {
    ...
    return (
        <>
            ...
            {selectedDocument && selectedDocument.status !== ENUMS.STATUS.ARCHIVED && <WorkFlowStatusModal<EmployeeRequest> handleClose={handleClose} open={open} selectedDocument={selectedDocument} />}
        </>
    );
};
