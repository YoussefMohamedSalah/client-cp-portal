...
import {
  EmployeeRequestKeys,
  EmployeeRequestNumKeys,
  EmployeeRequestRequiredKeys,
  EmployeeRequestStrKeys,
} from "models/documents/EmployeeRequest";
  ...
  const formFields: IField[] = [
    {
      ...
      onChange: (value: string | any) => handleModelData(EmployeeRequestKeys.SUBJECT, value),
    ...
    },
    {
      ...
      onChange: (value: string | any) => handleModelData(EmployeeRequestKeys.DATE, value),
      placeholder: "",
      required: true,
    ...
    },
    {
      ...
      onChange: (value: string | any) => handleModelData(EmployeeRequestKeys.DESCRIPTION, value),
      ...
      <div className="row g-3 pb-3 pb-xl-0">
        ...
        <div className="col-sm d-flex align-items-center justify-content-center gap-2">
          ...
          {isEdit ? (
            <>
              {allowEditActionBtn(
                documentData?.employeeRequestDetails?.data?.user?.id!,
                documentData?.employeeRequestDetails?.data!,
