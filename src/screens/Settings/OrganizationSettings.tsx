    ...
    const formFields: IField[] = [
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(CompanyKeys.NAME, value),
        ...
        },
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(CompanyKeys.EMAIL, value),
        ...
        },
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(CompanyKeys.ADDRESS, value),
        ...
        },
        {
            ...
            value: modelData?.address,
            onChange: (value: string | any) =>
                handleModelData(CompanyKeys.PHONE_NUMBER, value),
        ...
        },
        {
            ...
            value: modelData?.vat,
            onChange: (value: string | any) =>
                handleModelData(CompanyKeys.VAT, value),
        ...
        },
        {
            ...
            value: modelData?.vat,
            onChange: (value: string | any) =>
                handleModelData(CompanyKeys.CURRENCY, value),
        ...
        },
        {
            ...
            onChange: (value: string | any) =>
                handleModelData(CompanyKeys.SHIFT_START, value),
            ...
            onChange: (value: string | any) =>
                handleModelData(CompanyKeys.SHIFT_END, value),
