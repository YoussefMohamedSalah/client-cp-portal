      ...
      <div className="card-header py-3 d-flex justify-content-between border-top border-2">
        <div className="w-100  p-2 mb-1 ">
          <div className="d-flex flex-column justify-content-center align-items-center">
            <button type="button" className="btn btn-success text-white mb-2" onClick={() => handleAddCondition()}>
              Conditions
            ...
            <div className="row justify-content-center align-items-center row g-3 mb-3" key={index}>
              <div className="col-lg-11 d-flex justify-content-start align-items-center">
                ...
                <textarea
                  ...
                  value={condition}
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleConditionChange(index, e.target.value)}
                />
              </div>
              <div className="col-lg-1 col-6 p-lg-0 d-flex justify-content-evenly align-items-center">
                <button type="button" className="btn btn-danger" onClick={() => handleRemoveCondition(index)}>
