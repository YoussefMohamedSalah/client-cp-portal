      ...
      <div className="card teacher-card mb-3">
        ...
        <div className="card-body d-flex teacher-fullDetail">
          <div className="profile-teacher pe-xl-4 pe-md-2 pe-sm-4 pe-4 text-center w220">
            <a href="#!">
              <img src={getImageUrl(user?.avatar!)} alt="" className="avatar xl rounded-circle img-thumbnail shadow-sm" />
            </a>
            <div className="about-info d-flex align-items-center mt-3 justify-content-center flex-column">
              <h6 className="mb-1 fw-bold d-block fs-6">
                {user.role}
              </h6>
          ...
          <div className="teacher-info border-start ps-xl-4 ps-md-4 ps-sm-4 ps-4 w-100 d-flex flex-column justify-content-evenly">
              ...
              <div className="row g-2 pt-2">
                ...
                <div className="col-xl-5">
                  <div className="d-flex align-items-center">
                    ...
                    <span className="ms-2 small">
                      {user.address ? user.address : 'Add Personal Address'}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="d-flex w-100 gap-3 justify-content-lg-start justify-content-center pt-3 pt-xl-0 ">
              <button id="dropdown-basic" className="btn btn-primary dropdown-toggle" onClick={() => setIsModal(!isModal)}>
                Change Password
              </button>
              <Modal
                centered
                  ...
                  <div className="modal-body">
                    <form className="px-2 py-2" onSubmit={e => handleSubmit(e)}>
                      <div className="mb-3">
                        ...
                        <input onChange={(event: any) => handleChange('oldPassword', event.target.value)} type="password" className="form-control" id="exampleDropdownFormOldPassword1" placeholder="Old Password" />
                      </div>
                      <div className="mb-3">
                        <label htmlFor="exampleDropdownFormNewPassword1" className="form-label">
                          Password
                        </label>
                        <input onChange={(event: any) => handleChange('newPassword1', event.target.value)} type="password" className="form-control" id="exampleDropdownFormNewPassword1" placeholder="New Password" />
                      </div>
                      <div className="mb-3">
                        <input onChange={(event: any) => handleChange('newPassword2', event.target.value)} type="password" className="form-control" id="exampleDropdownFormNewPassword2" placeholder="New Password" />
                      </div>
