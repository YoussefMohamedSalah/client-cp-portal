...
const DocumentHeader = ({ logo, url }: Props) => {
	return (
		<div className="cart-header">
			<div className={`d-flex ${url ? "justify-content-between" : "justify-content-center"}  align-items-center pt-2 px-lg-4 px-3`}>
				{url && (
				...
				<div className='d-flex justify-content-center align-items-center w-full'>
					{logo && (
						<div className="mb-1" style={{ width: '8rem', height: '8rem', overflow: 'hidden', backgroundColor: "#cccccc" }}>
							<img
								className="mb-2"
