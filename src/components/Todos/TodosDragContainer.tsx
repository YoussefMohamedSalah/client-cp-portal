...
import { DeleteIcon, EditOutlinedIcon } from "components/Icons/MuiIcons";
        ...
        <DragDropContext onDragEnd={onDragEnd}>
          {groups.map((column) => (
            <Droppable key={column.id} droppableId={column.id}>
              {(provided) => (
                <div className="col-md-3" {...provided.droppableProps} ref={provided.innerRef}>
                  <div
                    className="card"
                    style={{
                      minHeight: 500,
