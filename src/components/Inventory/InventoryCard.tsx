      ...
      <div className="card">
        <div className="card-body">
          <div className="d-flex flex-column align-items-center justify-content-between mt-5">
            <div className="lesson_name pointer" onClick={() => push("/" + PAGES.INVENTORY + "/" + inventory.id)}>
              <div className="project-block light-info-bg">
                <i className="icofont-inbox" />
              </div>
              <span className="small text-muted project_name fw-bold">
                {" "}
                {inventory.type === INVENTORY_TYPE.MASTER ? "Company Main Inventory" : "Projects's Inventory"}{" "}
              </span>
            ...
            <div className="btn-group pt-2" role="group" aria-label="Basic outlined example">
              <button
                type="button"
          ...
          <div className="row g-2 pt-4">
            <div className="col-12">
              <div className="d-flex align-items-center">
                ...
                <span className="ms-2">Items Count: {inventory.items_count} </span>
              </div>
            </div>
            <div className="col-12">
              <div className="d-flex align-items-center">
                <i className="icofont-sand-clock" />
                <span className="ms-2">Total Value : {inventory.items_value} </span>
              </div>
            </div>
          </div>
          ...
          <div className="d-flex align-items-center justify-content-center mb-2">
            <button className="btn btn-primary btn-set-task w-sm-100 me-2" onClick={openModal}>
