        ...
        <Modal centered size="xl" show={isModal} onHide={onClose}>
            ...
            <Modal.Body>
                <div className="row g-3 py-1 pt-4">
                    {documentType === "po" && <DocumentsDetailsContent<PurchaseOrderRequest> data={modelData} finances={documentFinances ? documentFinances : {} as DocumentFinances} />}
                    ...
                    {documentType === "contract" && <DocumentsDetailsContent<Contract> data={modelData} finances={documentFinances ? documentFinances : {} as DocumentFinances} />}
